...
import { OrderModule } from '../order/order.moduel'
    ...
    <table>
        <tbody>
            <tr>
                ...
                <td></td>
                <td style="text-align: right;padding-right:20px">${
                  this.preferences.ShowTaxonBill ? this.Subtotal.toFixed(2) : Subtotal.toFixed(2)
                }</td>
            </tr>`
  ...
  printreceipt() {
    ...
    printtemplate += `
          ...
          <tr class="nb">
              ...
              <td colspan="2"></td>
              <td class="text-right">${(+this.Total.toFixed(0)).toFixed(2)}</td>
          </tr>
        </tbody>
      </table>
      <hr>

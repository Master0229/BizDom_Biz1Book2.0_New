...
export class AuthService {
  ...
  saveorder(payload) {
    return this.http.post(this.base_url + 'POSOrder/saveorder_2', payload)
  }
  ...
  saveordertonedb(order) {
    return this.http.post('http://localhost:8081/saveorder', order)
  }
  updateordertonedb(order) {
    return this.http.post('http://localhost:8081/updateorder', order)
  }
  deleteorderfromnedb(orderid) {
    return this.http.get('http://localhost:8081/deleteorder?_id=' + orderid)
  }
  updateorderkey(orderkey) {
    return this.http.post('http://localhost:8081/setorderkey', orderkey)
  }
  updateprintersettings(setting) {
    return this.http.post('http://localhost:8081/updateprintersettings', setting)
  }
}
